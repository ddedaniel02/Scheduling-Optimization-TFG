...
from mensual_sep import MultiObjectiveMixedVariableProblem, slots_ocupados
...
estudios = ["COVID", "Gripe", "Cancer de Mama"]
lista_sols = []
lista_objs = []
...
for estudio in estudios:
    problem = MultiObjectiveMixedVariableProblem(estudio)
    ...
    termination = RobustTermination(
        MultiObjectiveSpaceTermination(tol=0.005, n_skip=100), period=10)
